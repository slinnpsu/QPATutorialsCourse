...
**A note on color.** These bars are colored by a variable, so the colors carry meaning and have to be ones every reader can tell apart. This course sets a fixed palette for its plots --- the five hex codes introduced in Tutorial 4, chosen to stay distinguishable for readers with color-vision deficiency and to have enough contrast against the background, which ggplot's defaults do not. You do not need to do anything to use it here. In your own work, you would set it yourself:
...
question("Which statement best describes the cross-tab evidence?",
  ...
  answer("The pattern is consistent with the hypothesis --- conflict is less common among countries in alliances",
         correct = TRUE,
         message = "The conflict proportion is 0.150 for countries in alliances and 0.300 for countries not in alliances."),
