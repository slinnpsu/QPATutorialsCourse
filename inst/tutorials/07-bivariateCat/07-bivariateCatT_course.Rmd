...
Why might where a county sits on the urban--rural continuum matter for how it votes?
...
The theoretical explanation is that rural and urban counties often differ in their economic conditions, social composition, and political priorities. If Donald Trump's campaign was more successful in rural areas, then counties that are more rural should be more likely to have given Trump a majority of their votes.
...
Why might the racial composition of a county shape the way it votes?
...
Why might a country's form of government matter for the status of women?
...
The theoretical explanation is that democratic institutions may create more pressure for equal rights, representation, and policy responsiveness, while dictatorships may face fewer pressures to protect gender equality. For that reason, we might expect dictatorships to be less likely than democratic regimes to have high levels of gender equality.
...
Why might a country's alliance commitments matter for whether it ends up in a conflict?
...
The theoretical explanation is that alliances may deter conflict by raising the expected costs of attacking an alliance member. If potential challengers expect an alliance partner to help defend a country, they may be less likely to initiate a conflict.
