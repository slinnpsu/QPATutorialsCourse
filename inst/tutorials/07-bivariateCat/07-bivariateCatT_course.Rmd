...
This tutorial covers the first case.
...
This is the first plot in the tutorial that needs a `filter()` step. You have just seen what happens without one. Here you will write that step yourself, and for the first time it needs two conditions rather than one, because both variables have gaps.
