...
Each section opens with a research question and a hypothesis, builds the table, and asks whether the pattern in it matches what the hypothesis predicts. If you need to settle whether a variable counts as nominal or ordinal, Tutorial 3 is where that distinction is drawn.
...
The table collects the tools for describing the relationship between two categorical variables, and everything that follows explains why those are the ones to use and how to produce them in R. Tutorials 8 and 9 will add columns of their own as the combination of variable types changes.
