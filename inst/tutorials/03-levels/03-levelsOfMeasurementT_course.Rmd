...
question("What is the key difference between an ordinal variable and an interval variable?",
  correct = "Right. Order is what separates both from nominal variables. Equal distances are what separates interval from ordinal. Because ordinal gaps are not guaranteed to be equal, arithmetic on ordinal values is not justified --- you cannot meaningfully add or subtract ordinal categories the way you can add or subtract percentages or counts.",
