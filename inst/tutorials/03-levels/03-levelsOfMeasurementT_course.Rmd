...
Tutorials 1 and 2 gave you the tools to open a data set and see what is in it. This one asks what those values mean, and the answer governs every choice you make from here: the three tutorials that follow describe variables one at a time, and each uses a different set of statistics and graphs depending on the level of measurement.
