...
* How missing values affect frequency and proportion bar charts, and when to suppress an NA bar with `na.translate = FALSE` or filter missing cases before plotting
...
To illustrate how to compute a frequency table and identify the mode, you will examine the variable **TrumpMajority** in the **counties** data frame. This variable is stored as a numeric variable, assigning a value of 0 to counties where Clinton won a majority of the vote and 1 to counties where Trump won a majority. Every one of the 3,112 counties has a recorded value, so all of them will appear in the tables you build.
...
ggplot(data = counties,
  ...
  labs(title = "Number of US Counties by Racial Majority",
       ...
       caption = "Source: Linn, Nagler, Zilinsky") +
  scale_x_discrete(na.translate = FALSE,
                   labels = c("Other/No", "Hispanic", "Black", "White")) +
  coord_flip()
```
