...
question("The joint F-test gives F = 2.49 with p = .086. The Proportional interaction coefficient has p = .224 and the Mixed interaction coefficient has p = .027. Which statement best describes what the data tell us?",
  ...
  answer("The joint test does not clear .05, and the one contrast that does is not the one the hypothesis names",
         correct = TRUE,
         message = "This is the honest reading, and it shows why the two kinds of test answer different questions. The joint test at p = .086 does not let us reject equal slopes at .05. Yet the Mixed coefficient at p = .027 does clear it --- a single contrast can be statistically distinguishable even when the two interaction terms are not jointly distinguishable. The joint F-test evaluates both interaction terms simultaneously, whereas each coefficient test evaluates one specific contrast. And the contrast the hypothesis actually names, Proportional versus Plurality, has p = .224."),
