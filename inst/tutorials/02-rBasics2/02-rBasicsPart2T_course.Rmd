...
This check confirms that the new variable exists and that R calculated one value for each row of the data frame.
...
grade_this({
  ...
  pass("Nicely done! **attention** now combines likes and comments for each post, and `head()` confirms that R calculated one value for every row.")
})
```
