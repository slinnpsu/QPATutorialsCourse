...
question("A student runs `summary()` on a numeric variable, sees that the mean and median are close, and concludes that the values are tightly clustered. What is wrong with that reasoning?",
  correct = "Right. Close mean and median locate the center; they say nothing about spread.",
  answer("A close mean and median indicate symmetry, not low dispersion", correct = TRUE,
