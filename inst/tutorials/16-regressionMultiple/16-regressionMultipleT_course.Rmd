...
Two other things plausibly matter, and we will hold them constant rather than make them the focus of the hypothesis. An electoral gender quota is a deliberate intervention that changes what parties must do rather than what they are inclined to do. And representation accumulates over time, as parties build recruitment pipelines, women gain political experience, and voters grow accustomed to women as candidates --- so a parliament that has seated women for a century starts from a different place than one that seated its first in 2010.
...
question("What do the p-values tell us about the hypothesis and the controls? Select all that apply.",
  ...
  answer("Both controls are statistically distinguishable from zero: quotas at p < .001 and history at p = .009",
         correct = TRUE,
         message = "Controls are included to hold constant rather than to carry the focal hypotheses. Their coefficients can be tested like any other; they simply are not what this hypothesis is about. When they behave as theory predicts, that is reassuring about the model."),
