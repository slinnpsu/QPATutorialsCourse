...
**Assessing fit.** The [Multiple R-squared]{.important-text} gives the share of variation the model accounts for. The [Adjusted R-squared]{.important-text} penalizes for the number of predictors, so it does not automatically rise whenever one is added --- a guard against [overfitting]{.important-text}, and the right statistic for comparing models of different sizes, provided they are fitted to the same outcome and the same cases. The [residual standard error]{.important-text} answers a different question, in the units of the outcome: how far a typical case falls from the fitted line.
