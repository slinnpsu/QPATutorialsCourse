...
::: {.caution}
**Inference requires a defensible source of randomness or uncertainty.** In the simplest survey setting, that comes from random sampling. Standard inferential tools --- sampling distributions, standard errors, p-values, and confidence intervals --- assume the data have this property. Applying them to a convenience sample or a biased sample produces numbers that look precise but may be badly misleading.
:::
...
The bar chart gives us a visual summary, but we need a number: the proportion of red balls in the sample. This is our sample statistic --- our point estimate of the true proportion of red balls in the bowl, just as Gallup's 30% approval figure is their point estimate of the true approval rate among all American adults.
...
::: {.tip}
**Good place to take a break.** You have now covered samples, sampling variation, and sampling distributions, and seen how the sampling distribution is centered on the truth and how sample size affects precision. The next sections explain why these ideas allow us to compute standard errors and use the Central Limit Theorem.
:::
