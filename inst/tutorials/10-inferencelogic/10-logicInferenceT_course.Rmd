...
This tutorial covers the reasoning that makes such a statement possible. A different sample would have produced somewhat different numbers, and everything that follows rests on understanding how much they would have differed and why. You will see that variation directly by drawing samples over and over, watch the pattern the sample statistics form, and arrive at the standard error --- the number that says how far a sample estimate typically falls from the truth. Nothing here is a hypothesis test; every test in the tutorials that follow is built on what this one establishes.
...
Tutorial 11 uses this foundation to introduce the
