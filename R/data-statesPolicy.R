...
#' \describe{
#'   \item{State}{
#'     Full state name or \code{"District of Columbia"}.
#'   }
#'   \item{ST}{
#'     Two-letter U.S. postal abbreviation, including \code{"DC"} for the
#'     District of Columbia.
#'   }
#'   \item{Region}{
#'     U.S. Census region: \code{"Northeast"}, \code{"Midwest"},
#'     \code{"South"}, or \code{"West"}. Maryland is missing in the
#'     packaged data.
#'   }
#'   \item{South}{
...
#'     conservative in 2024. The District of Columbia is missing.
#'   }
#'   \item{party_governor2024}{
#'     Party of the sitting governor in 2024: \code{"Democrat"} or
#'     \code{"Republican"} in this dataset.
#'   }
...
#'     registered voters. The District of Columbia is missing.
#'   }
...
#'     Percentage of PRRI American Values Atlas respondents identifying as
#'     liberal in 2024. The District of Columbia is missing.
#'   }
#'   \item{pop_white2022}{
...
#'     nothing in particular. The District of Columbia is missing.
#'   }
...
#'     \code{"Republican"}, \code{"Democrat"}, or \code{"Divided"}.
...
#'     \code{"Republican"}, \code{"Democrat"}, \code{"Divided"}, or
#'     \code{"Nonpartisan"}.
#'   }
#' }
#'
